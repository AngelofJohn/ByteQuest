...
const VOCABULARY = {
  ...
  // Food vocabulary for baker quests
  food: {
    beginner: [
      { french: "le pain", english: "the bread", audio: null, hint: "Baked staple food" },
      { french: "le gâteau", english: "the cake", audio: null, hint: "Sweet dessert" },
      { french: "la tarte", english: "the pie/tart", audio: null, hint: "Pastry with filling" },
      { french: "le croissant", english: "the croissant", audio: null, hint: "Crescent-shaped pastry" },
      { french: "la baguette", english: "the baguette", audio: null, hint: "Long French bread" },
      { french: "le fromage", english: "the cheese", audio: null, hint: "Dairy product" },
      { french: "le beurre", english: "the butter", audio: null, hint: "Made from cream" },
      { french: "la farine", english: "the flour", audio: null, hint: "For baking" },
      { french: "le sucre", english: "the sugar", audio: null, hint: "Sweet ingredient" },
      { french: "le sel", english: "the salt", audio: null, hint: "Seasoning" },
      { french: "l'eau", english: "the water", audio: null, hint: "H2O" },
      { french: "le lait", english: "the milk", audio: null, hint: "From cows" }
    ]
  },

  // Time vocabulary for seasonal quests
  time: {
    basic: [
      ...
      { french: "le soir", english: "the evening", audio: null, hint: "Before night" },
      { french: "la semaine", english: "the week", audio: null, hint: "7 days" },
      { french: "le mois", english: "the month", audio: null, hint: "About 30 days" },
      { french: "l'année", english: "the year", audio: null, hint: "12 months" },
